...
@property (nonatomic, strong) UIViewController *rootViewController, *leftViewController, *rightViewController,*rrightViewController;
...
- (void)setRRightViewController:(UIViewController*)rightViewController width:(float)width rightViewFoldCount:(int)rightViewFoldCount rightViewPullFactor:(float)rightViewPullFactor;
@end
